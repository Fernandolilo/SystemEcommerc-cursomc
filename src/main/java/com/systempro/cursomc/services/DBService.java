...
public class DBService {
	...
	public void instantiateDatabase() throws ParseException {
		...
		categoriaRepositori.saveAll(Arrays.asList(cat1, cat2, cat3, cat4, cat5, cat6, cat7));
		produtoRepository.saveAll(Arrays.asList(p1, p2, p3,p4, p5, p6, p7, p8, p10, p11));
		...
		Cliente cli1 = new Cliente(null, "Fernando Silva", "fernando.nandotania@hotmail.com", "12312312311", TipoCliente.PESSOAFISICA);
